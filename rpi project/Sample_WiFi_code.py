  ...
  function updateStatus() {
    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState == 4 && xhr.status == 200) {
          ...
          if (results.output_status=="Spraying" && document.getElementById('spray').style.backgroundColor != 'green'){
          results_element.innerHTML = "Saturation Complete";
          }
          if (results.output_status=="Scanning" && document.getElementById('scan').style.backgroundColor != 'green'){
          results_element.innerHTML = "Spray complete";
          }
          else{
